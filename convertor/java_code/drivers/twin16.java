...
public class twin16
{
	...
	static InputPortPtr input_ports_twin16 = new InputPortPtr(){ public void handler() {  /* generic */
		PORT_START();       /* 0xa0001 */
	...
	static InputPortPtr input_ports_gradius2 = new InputPortPtr(){ public void handler() { 
		PORT_START();       /* 0xa0001 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );
	...
	static RomLoadPtr rom_devilw = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "687_l03.10a",		0x00000,  0x8000, 0x7201983c );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE( "687_q07.10n",	0x00000, 0x10000, 0x53110c0b );
		ROM_LOAD16_BYTE( "687_q06.8n",	0x00001, 0x10000, 0x9c53a0c5 );
		ROM_LOAD16_BYTE( "687_q13.10s",	0x20000, 0x10000, 0x36ae6014 );
		ROM_LOAD16_BYTE( "687_q12.8s",	0x20001, 0x10000, 0x6d012167 );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "687_t05.6n",	0x00000, 0x10000, 0x8ab7dc61 );
		ROM_LOAD16_BYTE( "687_t04.4n",	0x00001, 0x10000, 0xc69924da );
		ROM_LOAD16_BYTE( "687_t09.6r",	0x20000, 0x10000, 0xfae97de0 );
		ROM_LOAD16_BYTE( "687_t08.4r",	0x20001, 0x10000, 0x8c898d67 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "687_m14.d8",			0x00000,  0x4000, 0xd7338557 );/* characters */
	
		ROM_REGION16_LE( 0x200000, REGION_GFX2, 0 );/* gfx data used at runtime */
		ROM_LOAD16_WORD( "687i17.p16",	0x000000, 0x80000, 0x66cb3923 );
		ROM_LOAD16_WORD( "687i18.p18",	0x080000, 0x80000, 0xa1c7d0db );
		ROM_LOAD16_WORD( "687i15.p13",	0x100000, 0x80000, 0xeec8c5b2 );
		ROM_LOAD16_WORD( "687i16.p15",	0x180000, 0x80000, 0x746cf48b );
	
		ROM_REGION16_BE( 0x20000, REGION_GFX3, 0 );/* tile data; mapped at 0x80000 on CPUB */
		ROM_LOAD16_BYTE( "687_l11.10r",	0x00000, 0x10000, 0x399deee8 );
		ROM_LOAD16_BYTE( "687_l10.8r",	0x00001, 0x10000, 0x117c91ee );
	
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* samples */
		ROM_LOAD( "687_i01.5a",			0x00000, 0x20000, 0xd4992dfb );
	
		ROM_REGION( 0x20000, REGION_SOUND2, 0 );/* samples */
		ROM_LOAD( "687_i02.7c",			0x00000, 0x20000, 0xe5947501 );
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_majuu = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "687_s05.6n",	0x00000, 0x10000, 0xbd99b434 );
		ROM_LOAD16_BYTE( "687_s04.4n",	0x00001, 0x10000, 0x3df732e2 );
		ROM_LOAD16_BYTE( "687_s09.6r",	0x20000, 0x10000, 0x1f6efec3 );
		ROM_LOAD16_BYTE( "687_s08.4r",	0x20001, 0x10000, 0x8a16c8c6 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "687_l14.d8",			0x00000,  0x4000, 0x20ecccd6 );/* characters */
	...
	static RomLoadPtr rom_darkadv = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "687_n03.10a",		0x00000,  0x8000, 0xa24c682f );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE( "687_n07.10n",	0x00000, 0x10000, 0x6154322a );
		ROM_LOAD16_BYTE( "687_n06.8n",	0x00001, 0x10000, 0x37a72e8b );
		ROM_LOAD16_BYTE( "687_n13.10s",	0x20000, 0x10000, 0xf1c252af );
		ROM_LOAD16_BYTE( "687_n12.8s",	0x20001, 0x10000, 0xda221944 );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "687_n05.6n",	0x00000, 0x10000, 0xa9195b0b );
		ROM_LOAD16_BYTE( "687_n04.4n",	0x00001, 0x10000, 0x65b55105 );
		ROM_LOAD16_BYTE( "687_n09.6r",	0x20000, 0x10000, 0x1c6b594c );
		ROM_LOAD16_BYTE( "687_n08.4r",	0x20001, 0x10000, 0xa9603196 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "687_n14.d8",	0x0000,  0x4000, 0xc76ac6d2 );/* characters */
	...
	static RomLoadPtr rom_cuebrick = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "903_d03.10a",		0x00000,  0x8000, 0x455e855a );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE( "903_d07.10n",	0x00000, 0x10000, 0xfc0edce7 );
		ROM_LOAD16_BYTE( "903_d06.8n",	0x00001, 0x10000, 0xb2cef6fe );
		ROM_LOAD16_BYTE( "903_e13.10s",	0x20000, 0x10000, 0x4fb5fb80 );
		ROM_LOAD16_BYTE( "903_e12.8s",	0x20001, 0x10000, 0x883e3097 );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "903_e05.6n",	0x00000, 0x10000, 0x8b556220 );
		ROM_LOAD16_BYTE( "903_e04.4n",	0x00001, 0x10000, 0xbf9c7927 );
		ROM_LOAD16_BYTE( "903_e09.6r",	0x20000, 0x10000, 0x2a77554d );
		ROM_LOAD16_BYTE( "903_e08.4r",	0x20001, 0x10000, 0xc0a430c1 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "903_e14.d8",			0x0000, 0x4000, 0xddbebbd5 );/* characters */
	
		ROM_REGION( 0x200000, REGION_GFX2, 0 );/* gfx data used at runtime */
		/* unpopulated */
	
		ROM_REGION16_BE( 0x20000, REGION_GFX3, 0 );/* tile data; mapped at 0x80000 on CPUB */
		ROM_LOAD16_BYTE( "903_e11.10r",	0x00000, 0x10000, 0x5c41faf8 );
		ROM_LOAD16_BYTE( "903_e10.8r",	0x00001, 0x10000, 0x417576d4 );
	...
	static RomLoadPtr rom_vulcan = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "785_g03.10a",		0x00000,  0x8000, 0x67a3b50d );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE( "785_p07.10n",	0x00000, 0x10000, 0x686d549d );
		ROM_LOAD16_BYTE( "785_p06.8n" ,	0x00001, 0x10000, 0x70c94bee );
		ROM_LOAD16_BYTE( "785_p13.10s",	0x20000, 0x10000, 0x478fdb0a );
		ROM_LOAD16_BYTE( "785_p12.8s",	0x20001, 0x10000, 0x38ea402a );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "785_w05.6n",	0x00000, 0x10000, 0x6e0e99cd );
		ROM_LOAD16_BYTE( "785_w04.4n",	0x00001, 0x10000, 0x23ec74ca );
		ROM_LOAD16_BYTE( "785_w09.6r",	0x20000, 0x10000, 0x377e4f28 );
		ROM_LOAD16_BYTE( "785_w08.4r",	0x20001, 0x10000, 0x813d41ea );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "785_h14.d8",			0x0000,	0x4000, 0x02f4b16f );/* characters */
	
		ROM_REGION16_BE( 0x200000, REGION_GFX2, 0 );/* gfx data used at runtime */
		ROM_LOAD16_WORD( "785f17.p16",	0x000000, 0x80000, 0x8fbec1a4 );
		ROM_LOAD16_WORD( "785f18.p18",	0x080000, 0x80000, 0x50d61e38 );
		ROM_LOAD16_WORD( "785f15.p13",	0x100000, 0x80000, 0xaf96aef3 );
		ROM_LOAD16_WORD( "785f16.p15",	0x180000, 0x80000, 0xb858df1f );
	
		ROM_REGION( 0x20000, REGION_GFX3, 0 );/* tile data; mapped at 0x80000 on CPUB */
	
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* samples */
		ROM_LOAD( "785_f01.5a",			0x00000, 0x20000, 0xa0d8d69e );
	
		ROM_REGION( 0x20000, REGION_SOUND2, 0 );/* samples */
		ROM_LOAD( "785_f02.7c",			0x00000, 0x20000, 0xc39f5ca4 );
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_gradius2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "785_x05.6n",	0x00000, 0x10000, 0x8a23a7b8 );
		ROM_LOAD16_BYTE( "785_x04.4n",	0x00001, 0x10000, 0x88e466ce );
		ROM_LOAD16_BYTE( "785_x09.6r",	0x20000, 0x10000, 0x3f3d7d7a );
		ROM_LOAD16_BYTE( "785_x08.4r",	0x20001, 0x10000, 0xc39c8efd );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "785_g14.d8",			0x0000, 0x4000, 0x9dcdad9d );/* characters */
	...
	static RomLoadPtr rom_grdius2a = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "785_p05.6n",	0x00000, 0x10000, 0x4db0e736 );
		ROM_LOAD16_BYTE( "785_p04.4n",	0x00001, 0x10000, 0x765b99e6 );
		ROM_LOAD16_BYTE( "785_t09.6r",	0x20000, 0x10000, 0x4e3f4965 );
		ROM_LOAD16_BYTE( "785_j08.4r",	0x20001, 0x10000, 0x2b1c9108 );
	...
	static RomLoadPtr rom_grdius2b = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD16_BYTE( "785_p05.6n",	0x00000, 0x10000, 0x4db0e736 );
		ROM_LOAD16_BYTE( "785_p04.4n",	0x00001, 0x10000, 0x765b99e6 );
		ROM_LOAD16_BYTE( "785_j09.6r",	0x20000, 0x10000, 0x6d96a7e3 );
		ROM_LOAD16_BYTE( "785_j08.4r",	0x20001, 0x10000, 0x2b1c9108 );
	...
	static RomLoadPtr rom_hpuncher = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "870_g03.10a",		0x00000,  0x8000, 0xdb9c10c8 );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE( "870_h07.10n",	0x00000, 0x10000, 0xb4dda612 );
		ROM_LOAD16_BYTE( "870_h06.8n",	0x00001, 0x10000, 0x696ba702 );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "870_h05.6n",	0x00000, 0x10000, 0x2bcfeef3 );
		ROM_LOAD16_BYTE( "870_h04.4n",	0x00001, 0x10000, 0xb9f97fd3 );
		ROM_LOAD16_BYTE( "870_h09.6r",	0x20000, 0x10000, 0x96a4f8b1 );
		ROM_LOAD16_BYTE( "870_h08.4r",	0x20001, 0x10000, 0x46d65156 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD( "870_f14.d8",			0x0000, 0x4000, 0xc9b46615 );/* characters */
		...
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* samples */
		ROM_LOAD( "870_c01.5a",			0x00000, 0x20000, 0x6af96546 );
	
		ROM_REGION( 0x20000, REGION_SOUND2, 0 );/* samples */
		ROM_LOAD( "870_c02.7c",			0x00000, 0x20000, 0x54e12c6d );
	ROM_END(); }}; 
	
	static RomLoadPtr rom_fround = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "870_f03.10a",		0x00000,  0x8000, 0xa645c727 );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "870_m21.bin",	0x00000, 0x20000, 0x436dbffb );
		ROM_LOAD16_BYTE( "870_m20.bin",	0x00001, 0x20000, 0xb1c79d6a );
	...
	static RomLoadPtr rom_froundl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE( "870_l21.bin",	0x00000, 0x20000, 0xe21a3a19 );
		ROM_LOAD16_BYTE( "870_l20.bin",	0x00001, 0x20000, 0x0ce9786f );
	...
	static RomLoadPtr rom_miaj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (sound CPU) */
		ROM_LOAD( "808_e03.10a",		0x00000,  0x8000, 0x3d93a7cd );
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );/* 68000 code (CPU B) */
		ROM_LOAD16_BYTE("808_e07.10n",	0x00000, 0x10000, 0x297bdcea );
		ROM_LOAD16_BYTE("808_e06.8n",	0x00001, 0x10000, 0x8f576b33 );
		ROM_LOAD16_BYTE("808_e13.10s",	0x20000, 0x10000, 0x1fa708f4 );
		ROM_LOAD16_BYTE("808_e12.8s",	0x20001, 0x10000, 0xd62f1fde );
	
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* 68000 code (CPU A) */
		ROM_LOAD16_BYTE("808_r05.6n",	0x00000, 0x10000, 0x91fd83f4 );
		ROM_LOAD16_BYTE("808_r04.4n",	0x00001, 0x10000, 0xf1c8c597 );
		ROM_LOAD16_BYTE("808_r09.6r",	0x20000, 0x10000, 0xf74d4467 );
		ROM_LOAD16_BYTE("808_r08.4r",	0x20001, 0x10000, 0x26f21704 );
	
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );
		ROM_LOAD("808_e14.d8",			0x0000, 0x4000, 0xb9d36525 );/* characters */
	
		ROM_REGION16_LE( 0x200000, REGION_GFX2, 0 );/* gfx data used at runtime */
		ROM_LOAD16_WORD("808d17.p16",	0x000000, 0x80000, 0xd1299082 );
		ROM_LOAD16_WORD("808d15.p13",	0x100000, 0x80000, 0x2b22a6b6 );
	
		ROM_REGION( 0x20000, REGION_GFX3, 0 );/* tile data; mapped at 0x80000 on CPUB */
	
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* samples */
		ROM_LOAD("808_d01.5a",			0x00000, 0x20000, 0xfd4d37c0 );
