...
public class gionbana
{
	...
	public static GameDriver driver_hanamomo	   = new GameDriver("1988"	,"hanamomo"	,"gionbana.java"	,rom_hanamomo,null	,machine_driver_hanamomo	,input_ports_hanamomo	,init_hanamomo	,ROT0	,	"Nichibutsu", "Mahjong Hana no Momoko gumi (Japan)" )
	public static GameDriver driver_msjiken	   = new GameDriver("1988"	,"msjiken"	,"gionbana.java"	,rom_msjiken,null	,machine_driver_msjiken	,input_ports_msjiken	,init_msjiken	,ROT270	,	"Nichibutsu", "Mahjong Satsujin Jiken (Japan)" )
	public static GameDriver driver_telmahjn	   = new GameDriver("1988"	,"telmahjn"	,"gionbana.java"	,rom_telmahjn,null	,machine_driver_telmahjn	,input_ports_telmahjn	,init_telmahjn	,ROT270	,	"Nichibutsu", "Telephone Mahjong (Japan)" )
	public static GameDriver driver_gionbana	   = new GameDriver("1989"	,"gionbana"	,"gionbana.java"	,rom_gionbana,null	,machine_driver_gionbana	,input_ports_gionbana	,init_gionbana	,ROT0	,	"Nichibutsu", "Gionbana (Japan)" )
	public static GameDriver driver_mgmen89	   = new GameDriver("1989"	,"mgmen89"	,"gionbana.java"	,rom_mgmen89,null	,machine_driver_mgmen89	,input_ports_mgmen89	,init_mgmen89	,ROT0	,	"Nichibutsu", "Mahjong G-MEN'89 (Japan)" )
	public static GameDriver driver_mjfocus	   = new GameDriver("1989"	,"mjfocus"	,"gionbana.java"	,rom_mjfocus,null	,machine_driver_mjfocus	,input_ports_mjfocus	,init_mjfocus	,ROT0	,	"Nichibutsu", "Mahjong Focus (Japan)" )
	public static GameDriver driver_mjfocusm	   = new GameDriver("1989"	,"mjfocusm"	,"gionbana.java"	,rom_mjfocusm,driver_mjfocus	,machine_driver_mjfocusm	,input_ports_mjfocusm	,init_mjfocusm	,ROT0	,	"Nichibutsu", "Mahjong Focus [BET] (Japan)" )
	public static GameDriver driver_peepshow	   = new GameDriver("1989"	,"peepshow"	,"gionbana.java"	,rom_peepshow,driver_mjfocus	,machine_driver_peepshow	,input_ports_peepshow	,init_peepshow	,ROT0	,	"AC", "Nozokimeguri Mahjong Peep Show (Japan)" )
	public static GameDriver driver_scandal	   = new GameDriver("1989"	,"scandal"	,"gionbana.java"	,rom_scandal,null	,machine_driver_scandal	,input_ports_scandal	,init_scandal	,ROT0	,	"Nichibutsu", "Scandal Mahjong (Japan)" )
	public static GameDriver driver_scandalm	   = new GameDriver("1989"	,"scandalm"	,"gionbana.java"	,rom_scandalm,driver_scandal	,machine_driver_scandalm	,input_ports_scandalm	,init_scandalm	,ROT0	,	"Nichibutsu", "Scandal Mahjong [BET] (Japan)" )
	public static GameDriver driver_mjnanpas	   = new GameDriver("1989"	,"mjnanpas"	,"gionbana.java"	,rom_mjnanpas,null	,machine_driver_mjnanpas	,input_ports_mjnanpas	,init_mjnanpas	,ROT0	,	"BROOKS", "Mahjong Nanpa Story (Japan)" )
	public static GameDriver driver_mjnanpaa	   = new GameDriver("1989"	,"mjnanpaa"	,"gionbana.java"	,rom_mjnanpaa,driver_mjnanpas	,machine_driver_mjnanpas	,input_ports_mjnanpaa	,init_mjnanpas	,ROT0	,	"BROOKS", "Mahjong Nanpa Story (Japan old version)" )
	public static GameDriver driver_bananadr	   = new GameDriver("1989"	,"bananadr"	,"gionbana.java"	,rom_bananadr,null	,machine_driver_bananadr	,input_ports_bananadr	,init_bananadr	,ROT0	,	"DIGITAL SOFT", "Mahjong Banana Dream [BET] (Japan)" )
	public static GameDriver driver_club90s	   = new GameDriver("1990"	,"club90s"	,"gionbana.java"	,rom_club90s,null	,machine_driver_club90s	,input_ports_club90s	,init_club90s	,ROT0	,	"Nichibutsu", "Mahjong CLUB 90's (Japan)" )
	public static GameDriver driver_mladyhtr	   = new GameDriver("1990"	,"mladyhtr"	,"gionbana.java"	,rom_mladyhtr,null	,machine_driver_mladyhtr	,input_ports_mladyhtr	,init_mladyhtr	,ROT0	,	"Nichibutsu", "Mahjong THE LADY HUNTER (Japan)" )
	public static GameDriver driver_chinmoku	   = new GameDriver("1990"	,"chinmoku"	,"gionbana.java"	,rom_chinmoku,null	,machine_driver_chinmoku	,input_ports_chinmoku	,init_chinmoku	,ROT0	,	"Nichibutsu", "Mahjong Chinmoku no Hentai (Japan)" )
	public static GameDriver driver_maiko	   = new GameDriver("1990"	,"maiko"	,"gionbana.java"	,rom_maiko,null	,machine_driver_maiko	,input_ports_maiko	,init_maiko	,ROT0	,	"Nichibutsu", "Maikobana (Japan)" )
	public static GameDriver driver_hanaoji	   = new GameDriver("1991"	,"hanaoji"	,"gionbana.java"	,rom_hanaoji,null	,machine_driver_hanaoji	,input_ports_hanaoji	,init_hanaoji	,ROT0	,	"Nichibutsu", "Hana to Ojisan [BET]" )
}
