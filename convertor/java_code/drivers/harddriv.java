...
public class harddriv
{
	...
	*/
	...
	static RomLoadPtr rom_stunrnp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	/* 2MB for 68000 code */
		ROM_LOAD16_BYTE( "sr_200.r", 0x00000, 0x10000, 0xe0ed54d8 );
		ROM_LOAD16_BYTE( "sr_210.r", 0x00001, 0x10000, 0x3008bcf8 );
	...
	static RomLoadPtr rom_steeltdb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	/* 2MB for 68000 code */
	...
	public static GameDriver driver_harddriv	   = new GameDriver("1988"	,"harddriv"	,"harddriv.java"	,rom_harddriv,null	,machine_driver_harddriv	,input_ports_harddriv	,init_harddriv	,ROT0	,	"Atari Games", "Hard Drivin'", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_harddrvc	   = new GameDriver("1990"	,"harddrvc"	,"harddriv.java"	,rom_harddrvc,driver_harddriv	,machine_driver_racedriv	,input_ports_racedriv	,init_harddrvc	,ROT0	,	"Atari Games", "Hard Drivin' (compact)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_stunrun	   = new GameDriver("1989"	,"stunrun"	,"harddriv.java"	,rom_stunrun,null	,machine_driver_stunrun	,input_ports_stunrun	,init_stunrun	,ROT0	,	"Atari Games", "S.T.U.N. Runner" )
	public static GameDriver driver_stunrnp	   = new GameDriver("1989"	,"stunrnp"	,"harddriv.java"	,rom_stunrnp,driver_stunrun	,machine_driver_stunrun	,input_ports_stunrun	,init_stunrun	,ROT0	,	"Atari Games", "S.T.U.N. Runner (prototype)" )
	public static GameDriver driver_racedriv	   = new GameDriver("1990"	,"racedriv"	,"harddriv.java"	,rom_racedriv,null	,machine_driver_harddriv	,input_ports_racedriv	,init_racedriv	,ROT0	,	"Atari Games", "Race Drivin' (upgrade)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_racedrvc	   = new GameDriver("1990"	,"racedrvc"	,"harddriv.java"	,rom_racedrvc,driver_racedriv	,machine_driver_racedriv	,input_ports_racedriv	,init_racedrvc	,ROT0	,	"Atari Games", "Race Drivin' (compact)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_steeltal	   = new GameDriver("1990"	,"steeltal"	,"harddriv.java"	,rom_steeltal,null	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0	,	"Atari Games", "Steel Talons", GAME_NOT_WORKING )
	public static GameDriver driver_steeltdb	   = new GameDriver("1990"	,"steeltdb"	,"harddriv.java"	,rom_steeltdb,driver_steeltal	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0	,	"Atari Games", "Steel Talons (debug)", GAME_NOT_WORKING )
	public static GameDriver driver_hdrivair	   = new GameDriver("1993"	,"hdrivair"	,"harddriv.java"	,rom_hdrivair,null	,machine_driver_steeltal	,input_ports_hdrivair	,init_hdrivair	,ROT0	,	"Atari Games", "Hard Drivin's Airborne (prototype)", GAME_NOT_WORKING )
	public static GameDriver driver_hdrivaip	   = new GameDriver("1993"	,"hdrivaip"	,"harddriv.java"	,rom_hdrivaip,driver_hdrivair	,machine_driver_steeltal	,input_ports_hdrivair	,init_hdrivair	,ROT0	,	"Atari Games", "Hard Drivin's Airborne (prototype, early rev)", GAME_NOT_WORKING )
}
