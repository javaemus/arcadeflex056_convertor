...
public class overdriv
{
	...
	***************************************************************************/
	...
	static MachineDriver machine_driver_overdriv = new MachineDriver
	(
		...
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				24000000/2,	/* 12 MHz */
				overdriv_readmem,overdriv_writemem,null,null,
				cpuA_interrupt,4	/* ??? IRQ 4 is vblank, IRQ 5 of unknown origin */
			),
			new MachineCPU(
				CPU_M68000,
				24000000/2,	/* 12 MHz */
				overdriv_readmem2,overdriv_writemem2,null,null,
			...
			new MachineCPU(
				...
				overdriv_s_readmem,overdriv_s_writemem,null,null,
	...
	***************************************************************************/
	...
	static public static InitDriverPtr init_overdriv = new InitDriverPtr() { public void handler() 
	{
