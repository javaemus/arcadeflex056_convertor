...
public class namcona1
{
	...
	*/
	...
	public static GameDriver driver_bkrtmaq	   = new GameDriver("1992"	,"bkrtmaq"	,"namcona1.java"	,rom_bkrtmaq,null	,machine_driver_namcona1w	,input_ports_namcona1_quiz	,init_bkrtmaq	,ROT0	,	"Namco", "Bakuretsu Quiz Ma-Q Dai Bouken (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_cgangpzl	   = new GameDriver("1992"	,"cgangpzl"	,"namcona1.java"	,rom_cgangpzl,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_cgangpzl	,ROT0	,	"Namco", "Cosmo Gang the Puzzle (US)", GAME_NO_SOUND )
	public static GameDriver driver_cgangpzj	   = new GameDriver("1992"	,"cgangpzj"	,"namcona1.java"	,rom_cgangpzj,driver_cgangpzl	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_cgangpzl	,ROT0	,	"Namco", "Cosmo Gang the Puzzle (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_exvania	   = new GameDriver("1992"	,"exvania"	,"namcona1.java"	,rom_exvania,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_exbania	,ROT0	,	"Namco", "Exvania (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_fa	   = new GameDriver("1992"	,"fa"	,"namcona1.java"	,rom_fa,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_fa	,ROT0	,	*ROT90*/,"Namco", "F/A (Japan)", GAME_NO_SOUND|GAME_NOT_WORKING )
	public static GameDriver driver_knckhead	   = new GameDriver("1992"	,"knckhead"	,"namcona1.java"	,rom_knckhead,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_knckhead	,ROT0	,	"Namco", "Knuckle Heads (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_swcourt	   = new GameDriver("1992"	,"swcourt"	,"namcona1.java"	,rom_swcourt,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_swcourt	,ROT0	,	"Namco", "Super World Court (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_emeralda	   = new GameDriver("1993"	,"emeralda"	,"namcona1.java"	,rom_emeralda,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_emeralda	,ROT0	,	"Namco", "Emeraldia (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_numanath	   = new GameDriver("1993"	,"numanath"	,"namcona1.java"	,rom_numanath,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_numanath	,ROT0	,	"Namco", "Numan Athletics (Japan)", GAME_NO_SOUND|GAME_NOT_WORKING )
	public static GameDriver driver_quiztou	   = new GameDriver("1993"	,"quiztou"	,"namcona1.java"	,rom_quiztou,null	,machine_driver_namcona1w	,input_ports_namcona1_quiz	,init_quiztou	,ROT0	,	"Namco", "Nettou! Gekitou! Quiztou!! (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_tinklpit	   = new GameDriver("1993"	,"tinklpit"	,"namcona1.java"	,rom_tinklpit,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_tinklpit	,ROT0	,	"Namco", "Tinkle Pit (Japan)", GAME_NO_SOUND )
}
