...
public class _8080bw
{
	...
	/* 645 */ public static GameDriver driver_spcenctr	   = new GameDriver("1980"	,"spcenctr"	,"_8080bw.java"	,rom_spcenctr,null	,machine_driver_spcenctr	,input_ports_spcenctr	,init_spcenctr	,ROT0	,	"Midway", "Space Encounters", GAME_NO_SOUND )
	...
	/* 730 */ public static GameDriver driver_bowler	   = new GameDriver("1978"	,"bowler"	,"_8080bw.java"	,rom_bowler,null	,machine_driver_bowler	,input_ports_bowler	,init_8080bw	,ROT90	,	"Midway", "4 Player Bowling Alley", GAME_NO_SOUND )
	...
	/* Nintendo games */
			  ...
			  public static GameDriver driver_sfeverbw	   = new GameDriver("1980"	,"sfeverbw"	,"_8080bw.java"	,rom_sfeverbw,driver_spacefev	,machine_driver_sheriff	,input_ports_spacefev	,init_8080bw	,ROT270	,	"Nintendo", "Space Fever (black and white)", GAME_IMPERFECT_SOUND )
	...
	/* Misc. manufacturers */
			  ...
			  public static GameDriver driver_moonbase	   = new GameDriver("19??"	,"moonbase"	,"_8080bw.java"	,rom_moonbase,driver_invadpt2	,machine_driver_invaders	,input_ports_invadpt2	,init_invaddlx	,ROT270	,	"Nichibutsu", "Moon Base" )
			  public static GameDriver driver_invrvnge	   = new GameDriver("19??"	,"invrvnge"	,"_8080bw.java"	,rom_invrvnge,null	,machine_driver_tornbase	,input_ports_invrvnge	,init_invrvnge	,ROT270	,	"Zenitone Microsec", "Invader's Revenge",  GAME_NO_SOUND )
			  public static GameDriver driver_invrvnga	   = new GameDriver("19??"	,"invrvnga"	,"_8080bw.java"	,rom_invrvnga,driver_invrvnge	,machine_driver_tornbase	,input_ports_invrvnge	,init_invrvnge	,ROT270	,	"Zenitone Microsec (Dutchford license)", "Invader's Revenge (Dutchford)", GAME_NO_SOUND )
