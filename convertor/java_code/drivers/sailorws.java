...
public class sailorws
{
	...
	public static GameDriver driver_mjuraden	   = new GameDriver("1992"	,"mjuraden"	,"sailorws.java"	,rom_mjuraden,null	,machine_driver_mjuraden	,input_ports_mjuraden	,init_mjuraden	,ROT0	,	"Nichibutsu/Yubis", "Mahjong Uranai Densetsu (Japan)" )
	public static GameDriver driver_koinomp	   = new GameDriver("1992"	,"koinomp"	,"sailorws.java"	,rom_koinomp,null	,machine_driver_koinomp	,input_ports_koinomp	,init_koinomp	,ROT0	,	"Nichibutsu", "Mahjong Koi no Magic Potion (Japan)" )
	public static GameDriver driver_patimono	   = new GameDriver("1992"	,"patimono"	,"sailorws.java"	,rom_patimono,null	,machine_driver_patimono	,input_ports_patimono	,init_patimono	,ROT0	,	"Nichibutsu", "Mahjong Pachinko Monogatari (Japan)" )
	public static GameDriver driver_mjanbari	   = new GameDriver("1992"	,"mjanbari"	,"sailorws.java"	,rom_mjanbari,null	,machine_driver_mjanbari	,input_ports_mjanbari	,init_mjanbari	,ROT0	,	"Nichibutsu/Yubis/AV JAPAN", "Medal Mahjong Janjan Baribari [BET] (Japan)" )
	public static GameDriver driver_mmehyou	   = new GameDriver("1992"	,"mmehyou"	,"sailorws.java"	,rom_mmehyou,null	,machine_driver_mmehyou	,input_ports_mmehyou	,init_mmehyou	,ROT0	,	"Nichibutsu/Kawakusu", "Medal Mahjong Circuit no Mehyou [BET] (Japan)" )
	public static GameDriver driver_gal10ren	   = new GameDriver("1993"	,"gal10ren"	,"sailorws.java"	,rom_gal10ren,null	,machine_driver_gal10ren	,input_ports_gal10ren	,init_gal10ren	,ROT0	,	"FUJIC", "Mahjong Gal 10-renpatsu (Japan)" )
	public static GameDriver driver_mjlaman	   = new GameDriver("1993"	,"mjlaman"	,"sailorws.java"	,rom_mjlaman,null	,machine_driver_mjlaman	,input_ports_mjlaman	,init_mjlaman	,ROT0	,	"Nichibutsu/AV JAPAN", "Mahjong La Man (Japan)" )
	public static GameDriver driver_mkeibaou	   = new GameDriver("1993"	,"mkeibaou"	,"sailorws.java"	,rom_mkeibaou,null	,machine_driver_mkeibaou	,input_ports_mkeibaou	,init_mkeibaou	,ROT0	,	"Nichibutsu", "Mahjong Keibaou (Japan)" )
	public static GameDriver driver_pachiten	   = new GameDriver("1993"	,"pachiten"	,"sailorws.java"	,rom_pachiten,null	,machine_driver_pachiten	,input_ports_pachiten	,init_pachiten	,ROT0	,	"Nichibutsu/MIKI SYOUJI/AV JAPAN", "Medal Mahjong Pachi-Slot Tengoku [BET] (Japan)" )
	public static GameDriver driver_sailorws	   = new GameDriver("1993"	,"sailorws"	,"sailorws.java"	,rom_sailorws,null	,machine_driver_sailorws	,input_ports_sailorws	,init_sailorws	,ROT0	,	"Nichibutsu", "Mahjong Sailor Wars (Japan)" )
	public static GameDriver driver_sailorwr	   = new GameDriver("1993"	,"sailorwr"	,"sailorws.java"	,rom_sailorwr,driver_sailorws	,machine_driver_sailorwr	,input_ports_sailorwr	,init_sailorwr	,ROT0	,	"Nichibutsu", "Mahjong Sailor Wars-R [BET] (Japan)" )
	public static GameDriver driver_psailor1	   = new GameDriver("1994"	,"psailor1"	,"sailorws.java"	,rom_psailor1,null	,machine_driver_psailor1	,input_ports_psailor1	,init_psailor1	,ROT0	,	"SPHINX", "Bishoujo Janshi Pretty Sailor 18-kin (Japan)" )
	public static GameDriver driver_psailor2	   = new GameDriver("1994"	,"psailor2"	,"sailorws.java"	,rom_psailor2,null	,machine_driver_psailor2	,input_ports_psailor2	,init_psailor2	,ROT0	,	"SPHINX", "Bishoujo Janshi Pretty Sailor 2 (Japan)" )
	public static GameDriver driver_otatidai	   = new GameDriver("1995"	,"otatidai"	,"sailorws.java"	,rom_otatidai,null	,machine_driver_otatidai	,input_ports_otatidai	,init_otatidai	,ROT0	,	"SPHINX", "Disco Mahjong Otachidai no Okite (Japan)" )
	
	public static GameDriver driver_ngpgal	   = new GameDriver("1991"	,"ngpgal"	,"sailorws.java"	,rom_ngpgal,null	,machine_driver_ngpgal	,input_ports_ngpgal	,init_ngpgal	,ROT0	,	"Nichibutsu", "Nekketsu Grand-Prix Gal (Japan)" )
	public static GameDriver driver_mjgottsu	   = new GameDriver("1991"	,"mjgottsu"	,"sailorws.java"	,rom_mjgottsu,null	,machine_driver_mjgottsu	,input_ports_mjgottsu	,init_mjgottsu	,ROT0	,	"Nichibutsu", "Mahjong Gottsu ee-kanji (Japan)" )
	public static GameDriver driver_bakuhatu	   = new GameDriver("1991"	,"bakuhatu"	,"sailorws.java"	,rom_bakuhatu,driver_mjgottsu	,machine_driver_bakuhatu	,input_ports_bakuhatu	,init_bakuhatu	,ROT0	,	"Nichibutsu", "Mahjong Bakuhatsu Junjouden (Japan)" )
	public static GameDriver driver_cmehyou	   = new GameDriver("1992"	,"cmehyou"	,"sailorws.java"	,rom_cmehyou,null	,machine_driver_cmehyou	,input_ports_cmehyou	,init_cmehyou	,ROT0	,	"Nichibutsu/Kawakusu", "Mahjong Circuit no Mehyou (Japan)" )
	public static GameDriver driver_mjkoiura	   = new GameDriver("1992"	,"mjkoiura"	,"sailorws.java"	,rom_mjkoiura,null	,machine_driver_mjkoiura	,input_ports_mjkoiura	,init_mjkoiura	,ROT0	,	"Nichibutsu", "Mahjong Koi Uranai (Japan)" )
	
	public static GameDriver driver_mscoutm	   = new GameDriver("1994"	,"mscoutm"	,"sailorws.java"	,rom_mscoutm,null	,machine_driver_mscoutm	,input_ports_mscoutm	,init_mscoutm	,ROT0	,	"SPHINX/AV JAPAN", "Mahjong Scout Man (Japan)" )
	public static GameDriver driver_imekura	   = new GameDriver("1994"	,"imekura"	,"sailorws.java"	,rom_imekura,null	,machine_driver_imekura	,input_ports_imekura	,init_imekura	,ROT0	,	"SPHINX/AV JAPAN", "Imekura Mahjong (Japan)" )
	public static GameDriver driver_mjegolf	   = new GameDriver("1994"	,"mjegolf"	,"sailorws.java"	,rom_mjegolf,null	,machine_driver_mjegolf	,input_ports_mjegolf	,init_mjegolf	,ROT0	,	"FUJIC/AV JAPAN", "Mahjong Erotica Golf (Japan)" )
}
