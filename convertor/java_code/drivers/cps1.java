...
public class cps1
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_daimakai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );
	...
	static RomLoadPtr rom_sf2ua = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2ub = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
		ROM_LOAD16_BYTE( "sf2_30a.bin",   0x00000, 0x20000, 0x57bd7051 );
	...
	static RomLoadPtr rom_sf2ue = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2ui = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2ja = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
		ROM_LOAD16_BYTE( "sf2_30a.bin",   0x00000, 0x20000, 0x57bd7051 );
	...
	static RomLoadPtr rom_sf2jc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_3wonderu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_kodu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2ceua = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2ceub = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2rb2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sf2v004 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_wofu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	public static GameDriver driver_ghouls	   = new GameDriver("1988"	,"ghouls"	,"cps1.java"	,rom_ghouls,null	,machine_driver_cps1	,input_ports_ghouls	,init_cps1	,ROT0	,	Capcom", "Ghouls'n Ghosts (World)" )
	public static GameDriver driver_ghoulsu	   = new GameDriver("1988"	,"ghoulsu"	,"cps1.java"	,rom_ghoulsu,driver_ghouls	,machine_driver_cps1	,input_ports_ghouls	,init_cps1	,ROT0	,	Capcom", "Ghouls'n Ghosts (US)" )
	public static GameDriver driver_daimakai	   = new GameDriver("1988"	,"daimakai"	,"cps1.java"	,rom_daimakai,driver_ghouls	,machine_driver_cps1	,input_ports_ghouls	,init_cps1	,ROT0	,	Capcom", "Dai Makai-Mura (Japan)" )
	public static GameDriver driver_strider	   = new GameDriver("1989"	,"strider"	,"cps1.java"	,rom_strider,null	,machine_driver_cps1	,input_ports_strider	,init_cps1	,ROT0	,	Capcom", "Strider (US)" )
	...
	public static GameDriver driver_dwj	   = new GameDriver("1989"	,"dwj"	,"cps1.java"	,rom_dwj,null	,machine_driver_cps1	,input_ports_dwj	,init_cps1	,ROT0	,	Capcom", "Tenchi wo Kurau (Japan)" )
	public static GameDriver driver_willow	   = new GameDriver("1989"	,"willow"	,"cps1.java"	,rom_willow,null	,machine_driver_cps1	,input_ports_willow	,init_cps1	,ROT0	,	Capcom", "Willow (Japan, English)" )
	public static GameDriver driver_willowj	   = new GameDriver("1989"	,"willowj"	,"cps1.java"	,rom_willowj,driver_willow	,machine_driver_cps1	,input_ports_willow	,init_cps1	,ROT0	,	Capcom", "Willow (Japan, Japanese)" )
	...
	public static GameDriver driver_ffightu	   = new GameDriver("1989"	,"ffightu"	,"cps1.java"	,rom_ffightu,driver_ffight	,machine_driver_cps1	,input_ports_ffight	,init_cps1	,ROT0	,	Capcom", "Final Fight (US)" )
	public static GameDriver driver_ffightj	   = new GameDriver("1989"	,"ffightj"	,"cps1.java"	,rom_ffightj,driver_ffight	,machine_driver_cps1	,input_ports_ffight	,init_cps1	,ROT0	,	Capcom", "Final Fight (Japan)" )
	...
	public static GameDriver driver_mercs	   = new GameDriver("1990"	,"mercs"	,"cps1.java"	,rom_mercs,null	,machine_driver_cps1	,input_ports_mercs	,init_cps1	,ROT270	,	Capcom", "Mercs (World)" )
	public static GameDriver driver_mercsu	   = new GameDriver("1990"	,"mercsu"	,"cps1.java"	,rom_mercsu,driver_mercs	,machine_driver_cps1	,input_ports_mercs	,init_cps1	,ROT270	,	Capcom", "Mercs (US)" )
	public static GameDriver driver_mercsj	   = new GameDriver("1990"	,"mercsj"	,"cps1.java"	,rom_mercsj,driver_mercs	,machine_driver_cps1	,input_ports_mercs	,init_cps1	,ROT270	,	Capcom", "Senjo no Ookami II (Japan)" )
	public static GameDriver driver_mtwins	   = new GameDriver("1990"	,"mtwins"	,"cps1.java"	,rom_mtwins,null	,machine_driver_cps1	,input_ports_mtwins	,init_cps1	,ROT0	,	Capcom", "Mega Twins (World)" )
	public static GameDriver driver_chikij	   = new GameDriver("1990"	,"chikij"	,"cps1.java"	,rom_chikij,driver_mtwins	,machine_driver_cps1	,input_ports_mtwins	,init_cps1	,ROT0	,	Capcom", "Chiki Chiki Boys (Japan)" )
	public static GameDriver driver_msword	   = new GameDriver("1990"	,"msword"	,"cps1.java"	,rom_msword,null	,machine_driver_cps1	,input_ports_msword	,init_cps1	,ROT0	,	Capcom", "Magic Sword - Heroic Fantasy (World)" )
	public static GameDriver driver_mswordu	   = new GameDriver("1990"	,"mswordu"	,"cps1.java"	,rom_mswordu,driver_msword	,machine_driver_cps1	,input_ports_msword	,init_cps1	,ROT0	,	Capcom", "Magic Sword - Heroic Fantasy (US)" )
	public static GameDriver driver_mswordj	   = new GameDriver("1990"	,"mswordj"	,"cps1.java"	,rom_mswordj,driver_msword	,machine_driver_cps1	,input_ports_msword	,init_cps1	,ROT0	,	Capcom", "Magic Sword (Japan)" )
	public static GameDriver driver_cawing	   = new GameDriver("1990"	,"cawing"	,"cps1.java"	,rom_cawing,null	,machine_driver_cps1	,input_ports_cawing	,init_cps1	,ROT0	,	Capcom", "Carrier Air Wing (World)" )
	public static GameDriver driver_cawingj	   = new GameDriver("1990"	,"cawingj"	,"cps1.java"	,rom_cawingj,driver_cawing	,machine_driver_cps1	,input_ports_cawing	,init_cps1	,ROT0	,	Capcom", "U.S. Navy (Japan)" )
	public static GameDriver driver_nemo	   = new GameDriver("1990"	,"nemo"	,"cps1.java"	,rom_nemo,null	,machine_driver_cps1	,input_ports_nemo	,init_cps1	,ROT0	,	Capcom", "Nemo (World)" )
	public static GameDriver driver_nemoj	   = new GameDriver("1990"	,"nemoj"	,"cps1.java"	,rom_nemoj,driver_nemo	,machine_driver_cps1	,input_ports_nemo	,init_cps1	,ROT0	,	Capcom", "Nemo (Japan)" )
	public static GameDriver driver_sf2	   = new GameDriver("1991"	,"sf2"	,"cps1.java"	,rom_sf2,null	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	Capcom", "Street Fighter II - The World Warrior (World 910214)" )
	...
	public static GameDriver driver_3wonders	   = new GameDriver("1991"	,"3wonders"	,"cps1.java"	,rom_3wonders,null	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0	,	Capcom", "Three Wonders (World)" )
	public static GameDriver driver_3wonderu	   = new GameDriver("1991"	,"3wonderu"	,"cps1.java"	,rom_3wonderu,driver_3wonders	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0	,	Capcom", "Three Wonders (US)" )
	public static GameDriver driver_wonder3	   = new GameDriver("1991"	,"wonder3"	,"cps1.java"	,rom_wonder3,driver_3wonders	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0	,	Capcom", "Wonder 3 (Japan)" )
	public static GameDriver driver_kod	   = new GameDriver("1991"	,"kod"	,"cps1.java"	,rom_kod,null	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	Capcom", "The King of Dragons (World)" )
	public static GameDriver driver_kodu	   = new GameDriver("1991"	,"kodu"	,"cps1.java"	,rom_kodu,driver_kod	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	Capcom", "The King of Dragons (US)" )
	public static GameDriver driver_kodj	   = new GameDriver("1991"	,"kodj"	,"cps1.java"	,rom_kodj,driver_kod	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	Capcom", "The King of Dragons (Japan)" )
	public static GameDriver driver_kodb	   = new GameDriver("1991"	,"kodb"	,"cps1.java"	,rom_kodb,driver_kod	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	Capcom", "The King of Dragons (bootleg)", GAME_NOT_WORKING )
	public static GameDriver driver_captcomm	   = new GameDriver("1991"	,"captcomm"	,"cps1.java"	,rom_captcomm,null	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0	,	Capcom", "Captain Commando (World)" )
	public static GameDriver driver_captcomu	   = new GameDriver("1991"	,"captcomu"	,"cps1.java"	,rom_captcomu,driver_captcomm	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0	,	Capcom", "Captain Commando (US)" )
	public static GameDriver driver_captcomj	   = new GameDriver("1991"	,"captcomj"	,"cps1.java"	,rom_captcomj,driver_captcomm	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0	,	Capcom", "Captain Commando (Japan)" )
	public static GameDriver driver_knights	   = new GameDriver("1991"	,"knights"	,"cps1.java"	,rom_knights,null	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0	,	Capcom", "Knights of the Round (World)" )
	public static GameDriver driver_knightsu	   = new GameDriver("1991"	,"knightsu"	,"cps1.java"	,rom_knightsu,driver_knights	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0	,	Capcom", "Knights of the Round (US)" )
	public static GameDriver driver_knightsj	   = new GameDriver("1991"	,"knightsj"	,"cps1.java"	,rom_knightsj,driver_knights	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0	,	Capcom", "Knights of the Round (Japan)" )
	public static GameDriver driver_sf2ce	   = new GameDriver("1992"	,"sf2ce"	,"cps1.java"	,rom_sf2ce,null	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' - Champion Edition (World)" )
	public static GameDriver driver_sf2ceua	   = new GameDriver("1992"	,"sf2ceua"	,"cps1.java"	,rom_sf2ceua,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' - Champion Edition (US rev A)" )
	public static GameDriver driver_sf2ceub	   = new GameDriver("1992"	,"sf2ceub"	,"cps1.java"	,rom_sf2ceub,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' - Champion Edition (US rev B)" )
	public static GameDriver driver_sf2cej	   = new GameDriver("1992"	,"sf2cej"	,"cps1.java"	,rom_sf2cej,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' - Champion Edition (Japan)" )
	public static GameDriver driver_sf2rb	   = new GameDriver("1992"	,"sf2rb"	,"cps1.java"	,rom_sf2rb,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	hack",  "Street Fighter II' - Champion Edition (Rainbow set 1)" )
	public static GameDriver driver_sf2rb2	   = new GameDriver("1992"	,"sf2rb2"	,"cps1.java"	,rom_sf2rb2,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	hack",  "Street Fighter II' - Champion Edition (Rainbow set 2)" )
	public static GameDriver driver_sf2red	   = new GameDriver("1992"	,"sf2red"	,"cps1.java"	,rom_sf2red,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	hack",  "Street Fighter II' - Champion Edition (Red Wave)" )
	public static GameDriver driver_sf2v004	   = new GameDriver("1992"	,"sf2v004"	,"cps1.java"	,rom_sf2v004,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	hack",  "Street Fighter II! - Champion Edition (V004)" )
	public static GameDriver driver_sf2accp2	   = new GameDriver("1992"	,"sf2accp2"	,"cps1.java"	,rom_sf2accp2,driver_sf2ce	,machine_driver_sf2accp2	,input_ports_sf2	,init_cps1	,ROT0	,	hack",  "Street Fighter II' - Champion Edition (Accelerator Pt.II)" )
	public static GameDriver driver_varth	   = new GameDriver("1992"	,"varth"	,"cps1.java"	,rom_varth,null	,machine_driver_cps1	,input_ports_varth	,init_cps1	,ROT270	,	Capcom", "Varth - Operation Thunderstorm (World)" )
	public static GameDriver driver_varthu	   = new GameDriver("1992"	,"varthu"	,"cps1.java"	,rom_varthu,driver_varth	,machine_driver_cps1	,input_ports_varth	,init_cps1	,ROT270	,	Capcom (Romstar license)", "Varth - Operation Thunderstorm (US)" )
	public static GameDriver driver_varthj	   = new GameDriver("1992"	,"varthj"	,"cps1.java"	,rom_varthj,driver_varth	,machine_driver_cps1	,input_ports_varth	,init_cps1	,ROT270	,	Capcom", "Varth - Operation Thunderstorm (Japan)" )
	public static GameDriver driver_cworld2j	   = new GameDriver("1992"	,"cworld2j"	,"cps1.java"	,rom_cworld2j,null	,machine_driver_cps1	,input_ports_cworld2j	,init_cps1	,ROT0	,	Capcom", "Capcom World 2 (Japan)" )
	public static GameDriver driver_sf2t	   = new GameDriver("1992"	,"sf2t"	,"cps1.java"	,rom_sf2t,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' - Hyper Fighting (US)" )
	public static GameDriver driver_sf2tj	   = new GameDriver("1992"	,"sf2tj"	,"cps1.java"	,rom_sf2tj,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0	,	Capcom", "Street Fighter II' Turbo - Hyper Fighting (Japan)" )
	public static GameDriver driver_qad	   = new GameDriver("1992"	,"qad"	,"cps1.java"	,rom_qad,null	,machine_driver_cps1	,input_ports_qad	,init_cps1	,ROT0	,	Capcom", "Quiz & Dragons (US)" )
	public static GameDriver driver_qadj	   = new GameDriver("1994"	,"qadj"	,"cps1.java"	,rom_qadj,driver_qad	,machine_driver_cps1	,input_ports_qadj	,init_cps1	,ROT0	,	Capcom", "Quiz & Dragons (Japan)" )
	public static GameDriver driver_qtono2	   = new GameDriver("1995"	,"qtono2"	,"cps1.java"	,rom_qtono2,null	,machine_driver_cps1	,input_ports_qtono2	,init_cps1	,ROT0	,	Capcom", "Quiz Tonosama no Yabou 2 Zenkoku-ban (Japan)" )
	public static GameDriver driver_megaman	   = new GameDriver("1995"	,"megaman"	,"cps1.java"	,rom_megaman,null	,machine_driver_cps1	,input_ports_megaman	,init_cps1	,ROT0	,	Capcom", "Mega Man - The Power Battle (Asia)" )
	public static GameDriver driver_rockmanj	   = new GameDriver("1995"	,"rockmanj"	,"cps1.java"	,rom_rockmanj,driver_megaman	,machine_driver_cps1	,input_ports_megaman	,init_cps1	,ROT0	,	Capcom", "Rockman - The Power Battle (Japan)" )
	...
	public static GameDriver driver_wofu	   = new GameDriver("1992"	,"wofu"	,"cps1.java"	,rom_wofu,driver_wof	,machine_driver_qsound	,input_ports_wof	,init_wof	,ROT0	,	Capcom", "Warriors of Fate (US)" )
	...
	public static GameDriver driver_slammast	   = new GameDriver("1993"	,"slammast"	,"cps1.java"	,rom_slammast,null	,machine_driver_qsound	,input_ports_slammast	,init_slammast	,ROT0	,	Capcom", "Saturday Night Slam Masters (World)" )
	public static GameDriver driver_slammasu	   = new GameDriver("1993"	,"slammasu"	,"cps1.java"	,rom_slammasu,driver_slammast	,machine_driver_qsound	,input_ports_slammast	,init_slammast	,ROT0	,	Capcom", "Saturday Night Slam Masters (US)" )
	public static GameDriver driver_mbomberj	   = new GameDriver("1993"	,"mbomberj"	,"cps1.java"	,rom_mbomberj,driver_slammast	,machine_driver_qsound	,input_ports_slammast	,init_slammast	,ROT0	,	Capcom", "Muscle Bomber - The Body Explosion (Japan)" )
	public static GameDriver driver_mbombrd	   = new GameDriver("1993"	,"mbombrd"	,"cps1.java"	,rom_mbombrd,driver_slammast	,machine_driver_qsound	,input_ports_slammast	,init_slammast	,ROT0	,	Capcom", "Muscle Bomber Duo - Ultimate Team Battle (World)" )
	public static GameDriver driver_mbombrdj	   = new GameDriver("1993"	,"mbombrdj"	,"cps1.java"	,rom_mbombrdj,driver_slammast	,machine_driver_qsound	,input_ports_slammast	,init_slammast	,ROT0	,	Capcom", "Muscle Bomber Duo - Heat Up Warriors (Japan)" )
	
	public static GameDriver driver_pnickj	   = new GameDriver("1994"	,"pnickj"	,"cps1.java"	,rom_pnickj,null	,machine_driver_cps1	,input_ports_pnickj	,init_cps1	,ROT0	,	Compile (Capcom license)", "Pnickies (Japan)" )
	/* Japanese version of Pang 3 is encrypted, Euro version is not */
	public static GameDriver driver_pang3	   = new GameDriver("1995"	,"pang3"	,"cps1.java"	,rom_pang3,null	,machine_driver_pang3	,input_ports_pang3	,init_cps1	,ROT0	,	Mitchell", "Pang! 3 (Euro)" )
	public static GameDriver driver_pang3j	   = new GameDriver("1995"	,"pang3j"	,"cps1.java"	,rom_pang3j,driver_pang3	,machine_driver_pang3	,input_ports_pang3	,init_pang3	,ROT0	,	Mitchell", "Pang! 3 (Japan)" )
}
