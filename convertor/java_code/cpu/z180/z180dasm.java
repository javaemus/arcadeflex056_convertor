...
public class z180dasm
{
	...
	static z80dasm mnemonic_ed[256]= {
		{_0, zIN0,"b,(B)"}, {_0, zOUT0,"(B),b"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"b"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"c,(B)"}, {_0, zOUT0,"(B),c"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"c"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"d,(B)"}, {_0, zOUT0,"(B),d"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"d"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"e,(B)"}, {_0, zOUT0,"(B),e"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"e"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"h,(B)"}, {_0, zOUT0,"(B),h"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"h"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"l,(B)"}, {_0, zOUT0,"(B),l"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"l"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"f,(B)"}, {_0, zOUT0,"(B),0"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"(hl)"},  {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zIN0,"a,(B)"}, {_0, zOUT0,"(B),a"},{_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zTST,"a"},     {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		...
		{_0, zMLT,"bc"},    {_0, zRETI,0},      {_0, zIM,"0"},      {_0, zLD,"r,a"},
		...
		{_0, zTSTIO,"B"},   {_0, zRETN,0},      {_0, zSLP,0},       {_0, zDB,"?"},
		{_RP,zIN,"a,(c)"},  {_WP,zOUT,"(c),a"}, {_0, zADC,"hl,sp"}, {_RM,zLD,"sp,(W)"},
		{_0, zMLT,"sp"},    {_0, zRETI,0},      {_0, zIM,"2"},      {_0, zDB,"?"},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zOTIM,0},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zOTDM,0},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zOTIMR,0},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zOTDMR,0},
		{_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},      {_0, zDB,"?"},
