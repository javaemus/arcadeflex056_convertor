...
public class bjtwin
{
	...
	*/
	...
	public static Memory_ReadAddress tharrier_sound_readmem[]={
	...
	public static Memory_WriteAddress tharrier_sound_writemem[]={
	...
	public static IO_WritePort tharrier_sound_writeport[]={
	...
	public static GameDriver driver_urashima	   = new GameDriver("1989"	,"urashima"	,"bjtwin.java"	,rom_urashima,null	,machine_driver_urashima	,input_ports_macross	,null	,ROT0	,	UPL",							"Urashima Mahjong", GAME_UNEMULATED_PROTECTION | GAME_NOT_WORKING ) /* Similar Hardware? */
	public static GameDriver driver_tharrier	   = new GameDriver("1989"	,"tharrier"	,"bjtwin.java"	,rom_tharrier,null	,machine_driver_tharrier	,input_ports_tharrier	,null	,ROT270	,	UPL (American Sammy license)",	"Task Force Harrier", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_mustang	   = new GameDriver("1990"	,"mustang"	,"bjtwin.java"	,rom_mustang,null	,machine_driver_mustang	,input_ports_mustang	,null	,ROT0	,	UPL",							"US AAF Mustang (Japan)", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_mustangs	   = new GameDriver("1990"	,"mustangs"	,"bjtwin.java"	,rom_mustangs,driver_mustang	,machine_driver_mustang	,input_ports_mustang	,null	,ROT0	,	UPL (Seoul Trading license)",	"US AAF Mustang (Seoul Trading)", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_mustangb	   = new GameDriver("1990"	,"mustangb"	,"bjtwin.java"	,rom_mustangb,driver_mustang	,machine_driver_mustang	,input_ports_mustang	,null	,ROT0	,	bootleg",						"US AAF Mustang (bootleg)", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_bioship	   = new GameDriver("1990"	,"bioship"	,"bjtwin.java"	,rom_bioship,null	,machine_driver_bioship	,input_ports_bioship	,init_bioship	,ROT0	,	UPL (American Sammy license)",	"Bio-ship Paladin", GAME_NO_SOUND )
	public static GameDriver driver_vandyke	   = new GameDriver("1990"	,"vandyke"	,"bjtwin.java"	,rom_vandyke,null	,machine_driver_vandyke	,input_ports_vandyke	,null	,ROT270	,	UPL",							"Vandyke (Japan)",  GAME_NO_SOUND )
	public static GameDriver driver_blkheart	   = new GameDriver("1991"	,"blkheart"	,"bjtwin.java"	,rom_blkheart,null	,machine_driver_macross	,input_ports_vandyke	,null	,ROT0	,	UPL",							"Black Heart", GAME_NO_SOUND | GAME_UNEMULATED_PROTECTION | GAME_NOT_WORKING )
	public static GameDriver driver_blkhearj	   = new GameDriver("1991"	,"blkhearj"	,"bjtwin.java"	,rom_blkhearj,driver_blkheart	,machine_driver_macross	,input_ports_vandyke	,null	,ROT0	,	UPL",							"Black Heart (Japan)", GAME_NO_SOUND | GAME_UNEMULATED_PROTECTION | GAME_NOT_WORKING )
	public static GameDriver driver_acrobatm	   = new GameDriver("1991"	,"acrobatm"	,"bjtwin.java"	,rom_acrobatm,null	,machine_driver_acrobatm	,input_ports_strahl	,init_acrobatm	,ROT270	,	UPL (Taito license)",			"Acrobat Mission", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_strahl	   = new GameDriver("1992"	,"strahl"	,"bjtwin.java"	,rom_strahl,null	,machine_driver_strahl	,input_ports_strahl	,init_strahl	,ROT0	,	UPL",							"Koutetsu Yousai Strahl (Japan set 1)", GAME_NO_SOUND )
	public static GameDriver driver_strahla	   = new GameDriver("1992"	,"strahla"	,"bjtwin.java"	,rom_strahla,driver_strahl	,machine_driver_strahl	,input_ports_strahl	,init_strahl	,ROT0	,	UPL",							"Koutetsu Yousai Strahl (Japan set 2)", GAME_NO_SOUND )
	public static GameDriver driver_tdragon	   = new GameDriver("1991"	,"tdragon"	,"bjtwin.java"	,rom_tdragon,null	,machine_driver_tdragon	,input_ports_tdragon	,init_tdragon	,ROT270	,	NMK / Tecmo",					"Thunder Dragon", GAME_UNEMULATED_PROTECTION | GAME_NOT_WORKING )
	public static GameDriver driver_tdragonb	   = new GameDriver("1991"	,"tdragonb"	,"bjtwin.java"	,rom_tdragonb,driver_tdragon	,machine_driver_tdragon	,input_ports_tdragon	,init_tdragonb	,ROT270	,	NMK / Tecmo",					"Thunder Dragon (Bootleg)", GAME_NO_SOUND )
	public static GameDriver driver_hachamf	   = new GameDriver("1991"	,"hachamf"	,"bjtwin.java"	,rom_hachamf,null	,machine_driver_hachamf	,input_ports_hachamf	,init_hachamf	,ROT0	,	NMK",							"Hacha Mecha Fighter", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_macross	   = new GameDriver("1992"	,"macross"	,"bjtwin.java"	,rom_macross,null	,machine_driver_macross	,input_ports_macross	,init_nmk	,ROT270	,	Banpresto",					"Macross", GAME_NO_SOUND )
	public static GameDriver driver_gunnail	   = new GameDriver("1993"	,"gunnail"	,"bjtwin.java"	,rom_gunnail,null	,machine_driver_gunnail	,input_ports_gunnail	,init_nmk	,ROT270	,	NMK / Tecmo",					"GunNail", GAME_NO_SOUND )
	public static GameDriver driver_macross2	   = new GameDriver("1993"	,"macross2"	,"bjtwin.java"	,rom_macross2,null	,machine_driver_macross2	,input_ports_macross2	,null	,ROT0	,	Banpresto",					"Macross II", GAME_NO_COCKTAIL )
	public static GameDriver driver_tdragon2	   = new GameDriver("1993"	,"tdragon2"	,"bjtwin.java"	,rom_tdragon2,null	,machine_driver_macross2	,input_ports_tdragon2	,null	,ROT270	,	NMK",				         	"Thunder Dragon 2", GAME_NO_COCKTAIL )
	public static GameDriver driver_sabotenb	   = new GameDriver("1992"	,"sabotenb"	,"bjtwin.java"	,rom_sabotenb,null	,machine_driver_bjtwin	,input_ports_sabotenb	,init_nmk	,ROT0	,	NMK / Tecmo",					"Saboten Bombers", GAME_NO_COCKTAIL )
	public static GameDriver driver_bjtwin	   = new GameDriver("1993"	,"bjtwin"	,"bjtwin.java"	,rom_bjtwin,null	,machine_driver_bjtwin	,input_ports_bjtwin	,init_bjtwin	,ROT270	,	NMK",							"Bombjack Twin", GAME_NO_COCKTAIL )
	public static GameDriver driver_nouryoku	   = new GameDriver("1995"	,"nouryoku"	,"bjtwin.java"	,rom_nouryoku,null	,machine_driver_bjtwin	,input_ports_nouryoku	,init_nmk	,ROT0	,	Tecmo",						"Nouryoku Koujou Iinkai", GAME_NO_COCKTAIL )
}
