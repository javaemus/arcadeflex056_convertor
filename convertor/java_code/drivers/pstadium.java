...
public class pstadium
{
	...
	public static GameDriver driver_pstadium	   = new GameDriver("1990"	,"pstadium"	,"pstadium.java"	,rom_pstadium,null	,machine_driver_pstadium	,input_ports_pstadium	,init_pstadium	,ROT0	,	"Nichibutsu", "Mahjong Panic Stadium (Japan)" )
	public static GameDriver driver_triplew1	   = new GameDriver("1989"	,"triplew1"	,"pstadium.java"	,rom_triplew1,null	,machine_driver_triplew1	,input_ports_triplew1	,init_triplew1	,ROT0	,	"Nichibutsu", "Mahjong Triple Wars (Japan)" )
	public static GameDriver driver_triplew2	   = new GameDriver("1990"	,"triplew2"	,"pstadium.java"	,rom_triplew2,null	,machine_driver_triplew2	,input_ports_triplew1	,init_triplew2	,ROT0	,	"Nichibutsu", "Mahjong Triple Wars 2 (Japan)" )
	public static GameDriver driver_ntopstar	   = new GameDriver("1990"	,"ntopstar"	,"pstadium.java"	,rom_ntopstar,null	,machine_driver_ntopstar	,input_ports_ntopstar	,init_ntopstar	,ROT0	,	"Nichibutsu", "Mahjong Nerae! Top Star (Japan)" )
	public static GameDriver driver_mjlstory	   = new GameDriver("1991"	,"mjlstory"	,"pstadium.java"	,rom_mjlstory,null	,machine_driver_mjlstory	,input_ports_mjlstory	,init_mjlstory	,ROT0	,	"Nichibutsu", "Mahjong Jikken Love Story (Japan)" )
	public static GameDriver driver_vanilla	   = new GameDriver("1991"	,"vanilla"	,"pstadium.java"	,rom_vanilla,null	,machine_driver_vanilla	,input_ports_vanilla	,init_vanilla	,ROT0	,	"Nichibutsu", "Mahjong Vanilla Syndrome (Japan)" )
	public static GameDriver driver_finalbny	   = new GameDriver("1991"	,"finalbny"	,"pstadium.java"	,rom_finalbny,driver_vanilla	,machine_driver_finalbny	,input_ports_finalbny	,init_finalbny	,ROT0	,	"Nichibutsu", "Mahjong Final Bunny [BET] (Japan)" )
	public static GameDriver driver_qmhayaku	   = new GameDriver("1991"	,"qmhayaku"	,"pstadium.java"	,rom_qmhayaku,null	,machine_driver_qmhayaku	,input_ports_qmhayaku	,init_qmhayaku	,ROT0	,	"Nichibutsu", "Quiz-Mahjong Hayaku Yatteyo! (Japan)" )
	public static GameDriver driver_galkoku	   = new GameDriver("1989"	,"galkoku"	,"pstadium.java"	,rom_galkoku,null	,machine_driver_galkoku	,input_ports_galkoku	,init_galkoku	,ROT0	,	"Nichibutsu/T.R.TEC", "Mahjong Gal no Kokuhaku (Japan)" )
	public static GameDriver driver_hyouban	   = new GameDriver("1989"	,"hyouban"	,"pstadium.java"	,rom_hyouban,driver_galkoku	,machine_driver_hyouban	,input_ports_hyouban	,init_hyouban	,ROT0	,	"Nichibutsu/T.R.TEC", "Mahjong Hyouban Musume [BET] (Japan)" )
	public static GameDriver driver_galkaika	   = new GameDriver("1989"	,"galkaika"	,"pstadium.java"	,rom_galkaika,null	,machine_driver_galkaika	,input_ports_galkaika	,init_galkaika	,ROT0	,	"Nichibutsu/T.R.TEC", "Mahjong Gal no Kaika (Japan)" )
	public static GameDriver driver_tokyogal	   = new GameDriver("1989"	,"tokyogal"	,"pstadium.java"	,rom_tokyogal,null	,machine_driver_tokyogal	,input_ports_tokyogal	,init_tokyogal	,ROT0	,	"Nichibutsu", "Tokyo Gal Zukan (Japan)" )
	public static GameDriver driver_tokimbsj	   = new GameDriver("1989"	,"tokimbsj"	,"pstadium.java"	,rom_tokimbsj,driver_tokyogal	,machine_driver_tokimbsj	,input_ports_tokimbsj	,init_tokimbsj	,ROT0	,	"Nichibutsu", "Tokimeki Bishoujo [BET] (Japan)" )
	public static GameDriver driver_mcontest	   = new GameDriver("1989"	,"mcontest"	,"pstadium.java"	,rom_mcontest,null	,machine_driver_mcontest	,input_ports_mcontest	,init_mcontest	,ROT0	,	"Nichibutsu", "Miss Mahjong Contest (Japan)" )
	public static GameDriver driver_av2mj1	   = new GameDriver("1991"	,"av2mj1"	,"pstadium.java"	,rom_av2mj1,null	,machine_driver_av2mj1	,input_ports_av2mj1	,init_av2mj1	,ROT0	,	"MIKI SYOUJI/AV JAPAN", "AV2Mahjong No.1 Bay Bridge no Seijo", GAME_NOT_WORKING )
}
