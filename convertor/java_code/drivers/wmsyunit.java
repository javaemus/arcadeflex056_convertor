...
public class wmsyunit
{
	...
	public static GameDriver driver_narc	   = new GameDriver("1988"	,"narc"	,"wmsyunit.java"	,rom_narc,null	,machine_driver_zunit	,input_ports_narc	,init_narc	,ROT0	,	"Williams", "Narc (rev 7.00)" )
	public static GameDriver driver_narc3	   = new GameDriver("1988"	,"narc3"	,"wmsyunit.java"	,rom_narc3,driver_narc	,machine_driver_zunit	,input_ports_narc	,init_narc3	,ROT0	,	"Williams", "Narc (rev 3.20)" )
	
	public static GameDriver driver_trog	   = new GameDriver("1990"	,"trog"	,"wmsyunit.java"	,rom_trog,null	,machine_driver_yunit_cvsd_4bit	,input_ports_trog	,init_trog	,ROT0	,	"Midway",   "Trog (rev LA4 03/11/91)" )
	public static GameDriver driver_trog3	   = new GameDriver("1990"	,"trog3"	,"wmsyunit.java"	,rom_trog3,driver_trog	,machine_driver_yunit_cvsd_4bit	,input_ports_trog	,init_trog3	,ROT0	,	"Midway",   "Trog (rev LA3 02/14/91)" )
	public static GameDriver driver_trogp	   = new GameDriver("1990"	,"trogp"	,"wmsyunit.java"	,rom_trogp,driver_trog	,machine_driver_yunit_cvsd_4bit	,input_ports_trog	,init_trogp	,ROT0	,	"Midway",   "Trog (prototype, rev 4.00 07/27/90)" )
	public static GameDriver driver_strkforc	   = new GameDriver("1991"	,"strkforc"	,"wmsyunit.java"	,rom_strkforc,null	,machine_driver_yunit_cvsd_4bit	,input_ports_strkforc	,init_strkforc	,ROT0	,	"Midway",   "Strike Force (rev 1 02/25/91)" )
	
	public static GameDriver driver_smashtv	   = new GameDriver("1990"	,"smashtv"	,"wmsyunit.java"	,rom_smashtv,null	,machine_driver_yunit_cvsd_6bit	,input_ports_smashtv	,init_smashtv	,ROT0	,	"Williams", "Smash T.V. (rev 8.00)" )
	public static GameDriver driver_smashtv6	   = new GameDriver("1990"	,"smashtv6"	,"wmsyunit.java"	,rom_smashtv6,driver_smashtv	,machine_driver_yunit_cvsd_6bit	,input_ports_smashtv	,init_smashtv	,ROT0	,	"Williams", "Smash T.V. (rev 6.00)" )
	public static GameDriver driver_smashtv5	   = new GameDriver("1990"	,"smashtv5"	,"wmsyunit.java"	,rom_smashtv5,driver_smashtv	,machine_driver_yunit_cvsd_6bit	,input_ports_smashtv	,init_smashtv	,ROT0	,	"Williams", "Smash T.V. (rev 5.00)" )
	public static GameDriver driver_smashtv4	   = new GameDriver("1990"	,"smashtv4"	,"wmsyunit.java"	,rom_smashtv4,driver_smashtv	,machine_driver_yunit_cvsd_6bit	,input_ports_smashtv	,init_smashtv4	,ROT0	,	"Williams", "Smash T.V. (rev 4.00)" )
	public static GameDriver driver_hiimpact	   = new GameDriver("1990"	,"hiimpact"	,"wmsyunit.java"	,rom_hiimpact,null	,machine_driver_yunit_cvsd_6bit	,input_ports_trog	,init_hiimpact	,ROT0	,	"Williams", "High Impact Football (rev LA3 12/27/90)" )
	public static GameDriver driver_shimpact	   = new GameDriver("1991"	,"shimpact"	,"wmsyunit.java"	,rom_shimpact,null	,machine_driver_yunit_cvsd_6bit	,input_ports_trog	,init_shimpact	,ROT0	,	"Midway",   "Super High Impact (rev LA1 09/30/91)", GAME_NOT_WORKING )
	
	public static GameDriver driver_term2	   = new GameDriver("1991"	,"term2"	,"wmsyunit.java"	,rom_term2,null	,machine_driver_yunit_adpcm	,input_ports_term2	,init_term2	,ROT0	,	"Midway",   "Terminator 2 - Judgment Day (rev LA3 03/27/92)" )
	public static GameDriver driver_mkla1	   = new GameDriver("1992"	,"mkla1"	,"wmsyunit.java"	,rom_mkla1,driver_mk	,machine_driver_yunit_adpcm	,input_ports_mkla1	,init_mkla1	,ROT0	,	"Midway",   "Mortal Kombat (rev 1.0 08/08/92)" )
	public static GameDriver driver_mkla2	   = new GameDriver("1992"	,"mkla2"	,"wmsyunit.java"	,rom_mkla2,driver_mk	,machine_driver_yunit_adpcm	,input_ports_mkla1	,init_mkla2	,ROT0	,	"Midway",   "Mortal Kombat (rev 2.0 08/18/92)" )
	public static GameDriver driver_mkla3	   = new GameDriver("1992"	,"mkla3"	,"wmsyunit.java"	,rom_mkla3,driver_mk	,machine_driver_yunit_adpcm	,input_ports_mkla1	,init_mkla3	,ROT0	,	"Midway",   "Mortal Kombat (rev 3.0 08/31/92)" )
	public static GameDriver driver_mkla4	   = new GameDriver("1992"	,"mkla4"	,"wmsyunit.java"	,rom_mkla4,driver_mk	,machine_driver_yunit_adpcm	,input_ports_mkla1	,init_mkla4	,ROT0	,	"Midway",   "Mortal Kombat (rev 4.0 09/28/92)" )
	public static GameDriver driver_totcarn	   = new GameDriver("1992"	,"totcarn"	,"wmsyunit.java"	,rom_totcarn,null	,machine_driver_yunit_adpcm	,input_ports_totcarn	,init_totcarn	,ROT0	,	"Midway",   "Total Carnage (rev LA1 03/10/92)" )
	public static GameDriver driver_totcarnp	   = new GameDriver("1992"	,"totcarnp"	,"wmsyunit.java"	,rom_totcarnp,driver_totcarn	,machine_driver_yunit_adpcm	,input_ports_totcarn	,init_totcarnp	,ROT0	,	"Midway",   "Total Carnage (prototype, rev 1.0 01/25/92)" )
}
