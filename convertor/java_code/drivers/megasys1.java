...
public class megasys1
{
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress sound_readmem_z80[]={
	...
	***************************************************************************/
	...
	static MachineDriver machine_driver_system_##_type_ = new MachineDriver\
	( \
		new MachineCPU[] { \
			new MachineCPU( \
				CPU_M68000, \
				_main_clock_, \
				readmem_##_type_,writemem_##_type_,null,null, \
				interrupt_##_type_,INTERRUPT_NUM_##_type_ \
			), \
			new MachineCPU( \
				CPU_M68000 | CPU_AUDIO_CPU, \
				_sound_clock_, \
				sound_readmem_##_type_,sound_writemem_##_type_,null,null, \
	...
	static MachineDriver machine_driver_jitsupro = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				12000000,
				readmem_A,writemem_A,null,null,
	...
	***************************************************************************/
	...
	static MachineDriver machine_driver_system_D = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				10000000,	/* ? */
				readmem_D,writemem_D,null,null,
		...
		0,0,0,0,
		new MachineSound[] {
			new MachineSound(	SOUND_OKIM6295,	okim6295_interface_D	)
		}
	);
	...
	***************************************************************************/
	...
	static MachineDriver machine_driver_system_Z = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
	...
	***************************************************************************/
	...
	public static GameDriver driver_iganinju	   = new GameDriver("1988"	,"iganinju"	,"megasys1.java"	,rom_iganinju,null	,machine_driver_system_A	,input_ports_iganinju	,init_iganinju	,ROT0	,	"Jaleco", "Iga Ninjyutsuden (Japan)" )
	...
	public static GameDriver driver_jitsupro	   = new GameDriver("1989"	,"jitsupro"	,"megasys1.java"	,rom_jitsupro,null	,machine_driver_jitsupro	,input_ports_jitsupro	,init_jitsupro	,ROT0	,	"Jaleco", "Jitsuryoku!! Pro Yakyuu (Japan)" )
	...
	public static GameDriver driver_edf	   = new GameDriver("1991"	,"edf"	,"megasys1.java"	,rom_edf,null	,machine_driver_system_B	,input_ports_edf	,init_edf	,ROT0	,	"Jaleco", "Earth Defense Force" )
	...
	public static GameDriver driver_chimerab	   = new GameDriver("1993"	,"chimerab"	,"megasys1.java"	,rom_chimerab,null	,machine_driver_system_C	,input_ports_chimerab	,init_chimerab	,ROT0	,	"Jaleco", "Chimera Beast" )
