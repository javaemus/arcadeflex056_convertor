...
public class rpunch
{
	...
	public static Memory_ReadAddress readmem_sound[]={
		...
		new Memory_ReadAddress( 0xf000, 0xf001, YM2151_status_port_0_r ),
		new Memory_ReadAddress( 0xf200, 0xf200, sound_command_r ),
	...
	(
		...
		4,
		new int[] { 0, 1, 2, 3 },
		new int[] { 12, 8, 4, 0, 28, 24, 20, 16, 44, 40, 36, 32, 60, 56, 52, 48 },
	...
	public static InitDriverPtr init_rabiolep = new InitDriverPtr() { public void handler() (void)
	{
		rpunch_sprite_palette = 0x300;
	} };
	
	
	public static InitDriverPtr init_svolley = new InitDriverPtr() { public void handler() (void)
	{
