...
public class bottom9
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bottom9 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD16_BYTE( "891e10c", 0x00000, 0x10000, 0x209b0431 );/* characters */
		ROM_LOAD16_BYTE( "891e10a", 0x00001, 0x10000, 0x8020a9e8 );
		ROM_LOAD16_BYTE( "891e10d", 0x20000, 0x10000, 0x16d5fd7a );
		ROM_LOAD16_BYTE( "891e10b", 0x20001, 0x10000, 0x30121cc0 );
		ROM_LOAD16_BYTE( "891e09c", 0x40000, 0x10000, 0x9dcaefbf );
		ROM_LOAD16_BYTE( "891e09a", 0x40001, 0x10000, 0x56b0ead9 );
		ROM_LOAD16_BYTE( "891e09d", 0x60000, 0x10000, 0x4e1335e6 );
		ROM_LOAD16_BYTE( "891e09b", 0x60001, 0x10000, 0xb6f914fb );
	
		ROM_REGION( 0x100000, REGION_GFX2, 0 );/* graphics ( dont dispose as the program can read them, 0 ) */
		ROM_LOAD16_BYTE( "891e06e", 0x00000, 0x10000, 0x0b04db1c );/* sprites */
		ROM_LOAD16_BYTE( "891e06a", 0x00001, 0x10000, 0x5ee37327 );
		ROM_LOAD16_BYTE( "891e06f", 0x20000, 0x10000, 0xf9ada524 );
		ROM_LOAD16_BYTE( "891e06b", 0x20001, 0x10000, 0x2295dfaa );
		ROM_LOAD16_BYTE( "891e06g", 0x40000, 0x10000, 0x04abf78f );
		ROM_LOAD16_BYTE( "891e06c", 0x40001, 0x10000, 0xdbdb0d55 );
		ROM_LOAD16_BYTE( "891e06h", 0x60000, 0x10000, 0x5d5ded8c );
		ROM_LOAD16_BYTE( "891e06d", 0x60001, 0x10000, 0xf9ecbd71 );
		ROM_LOAD16_BYTE( "891e05e", 0x80000, 0x10000, 0xb356e729 );
		ROM_LOAD16_BYTE( "891e05a", 0x80001, 0x10000, 0xbfd5487e );
		ROM_LOAD16_BYTE( "891e05f", 0xa0000, 0x10000, 0xecdd11c5 );
		ROM_LOAD16_BYTE( "891e05b", 0xa0001, 0x10000, 0xaba18d24 );
		ROM_LOAD16_BYTE( "891e05g", 0xc0000, 0x10000, 0xc315f9ae );
		ROM_LOAD16_BYTE( "891e05c", 0xc0001, 0x10000, 0x21fcbc6f );
		ROM_LOAD16_BYTE( "891e05h", 0xe0000, 0x10000, 0xb0aba53b );
		ROM_LOAD16_BYTE( "891e05d", 0xe0001, 0x10000, 0xf6d3f886 );
	...
	static RomLoadPtr rom_mstadium = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x28000, REGION_CPU1, 0 );/* code + banked roms */
		ROM_LOAD( "891-403.k17",   0x10000, 0x10000, 0x1c00c4e8 );
	    ROM_LOAD( "891-402.k15",   0x20000, 0x08000, 0xb850bbce );
	    ROM_CONTINUE(             0x08000, 0x08000 );
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* Z80 code */
		ROM_LOAD( "891w01.g8",    0x0000, 0x8000, 0xedec565a );
	...
	static public static InitDriverPtr init_bottom9 = new InitDriverPtr() { public void handler() 
	{
