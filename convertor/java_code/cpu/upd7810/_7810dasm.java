...
public class _7810dasm
{
	...
	static struct dasm_s dasm48[256] =
	{
		...
		{STOP,0,		 2,12}, /* bb: 0100 1000 1011 1011						*/
		...
		{DMOV,"EA,ECPT", 2,14}, /* c1: 0100 1000 1100 0001                      */
	...
	/* prefix 4C */
	static struct dasm_s  dasm4C[256] =
	{
		...
		{MOV,"A,ANM",    2,10}, /* c8: 0100 1100 1100 1000                      */
		...
		{MOV,"A,CR0",    2,10}, /* e0: 0100 1100 1110 0000                      */
		{MOV,"A,CR1",    2,10}, /* e1: 0100 1100 1110 0001                      */
		{MOV,"A,CR2",    2,10}, /* e2: 0100 1100 1110 0010                      */
		{MOV,"A,CR3",    2,10}, /* e3: 0100 1100 1110 0011                      */
	...
	/* prefix 4D */
	static struct dasm_s  dasm4D[256] =
	{
		...
		{MOV,"ANM,A",    2,10}, /* c8: 0100 1101 1100 1000                      */
		...
		{MOV,"ZCM,A",    2,10}, /* e8: 0100 1101 1110 1000                      */
	...
	/* prefix 64 */
	static struct dasm_s  dasm64[256] =
	{
		...
		{MVI,"ANM,%b",   3,14}, /* 80: 0110 0100 1000 0000 xxxx xxxx            */
		...
		{ANI,"ANM,%b",   3,20}, /* 88: 0110 0100 1000 1000 xxxx xxxx            */
		...
		{XRI,"ANM,%b",   3,20}, /* 90: 0110 0100 1001 0000 xxxx xxxx            */
		...
		{ORI,"ANM,%b",   3,20}, /* 98: 0110 0100 1001 1000 xxxx xxxx            */
		...
		{ADINC,"ANM,%b", 3,20}, /* a0: 0110 0100 1010 0000 xxxx xxxx            */
		...
		{GTI,"ANM,%b",   3,20}, /* a8: 0110 0100 1010 1000 xxxx xxxx            */
		...
		{SUINB,"ANM,%b", 3,20}, /* b0: 0110 0100 1011 0000 xxxx xxxx            */
		...
		{LTI,"ANM,%b",   3,20}, /* b8: 0110 0100 1011 1000 xxxx xxxx            */
		...
		{ADI,"ANM,%b",   3,20}, /* c0: 0110 0100 1100 0000 xxxx xxxx            */
		...
		{ONI,"ANM,%b",   3,20}, /* c8: 0110 0100 1100 1000 xxxx xxxx            */
		...
		{ACI,"ANM,%b",   3,20}, /* d0: 0110 0100 1101 0000 xxxx xxxx            */
		...
		{OFFI,"ANM,%b",  3,20}, /* d8: 0110 0100 1101 1000 xxxx xxxx            */
		...
		{SUI,"ANM,%b",   3,20}, /* e0: 0110 0100 1110 0000 xxxx xxxx            */
		...
		{NEI,"ANM,%b",   3,20}, /* e8: 0110 0100 1110 1000 xxxx xxxx            */
		...
		{SBI,"ANM,%b",   3,20}, /* f0: 0110 0100 1111 0000 xxxx xxxx            */
		...
		{EQI,"ANM,%b",   3,20}, /* f8: 0110 0100 1111 1000 xxxx xxxx            */
	...
	/* main opcodes */
	static struct dasm_s  dasmXX[256] =
	{
		...
		{EXA,0, 		 1, 4}, /* 10: 0001 0000								*/
		{EXX,0, 		 1, 4}, /* 11: 0001 0001								*/
		...
		{BIT,"0,%a",     2,10}, /* 58: 0101 1000 oooo oooo                      */
		{BIT,"1,%a",     2,10}, /* 59: 0101 1001 oooo oooo                      */
		{BIT,"2,%a",     2,10}, /* 5a: 0101 1010 oooo oooo                      */
		{BIT,"3,%a",     2,10}, /* 5b: 0101 1011 oooo oooo                      */
		{BIT,"4,%a",     2,10}, /* 5c: 0101 1100 oooo oooo                      */
		{BIT,"5,%a",     2,10}, /* 5d: 0101 1101 oooo oooo                      */
		{BIT,"6,%a",     2,10}, /* 5e: 0101 1110 oooo oooo                      */
		{BIT,"7,%a",     2,10}, /* 5f: 0101 1111 oooo oooo                      */
	
		{0,dasm60,		 0, 0}, /* 60: prefix									*/
		{DAA,0, 		 1, 4}, /* 61: 0110 0001								*/
		{RETI,0,		 1,13}, /* 62: 0110 0010								*/
		{STAW,"%a",      2,10}, /* 63: 0110 0011 oooo oooo                      */
		{0,dasm64,		 0, 0}, /* 64: prefix									*/
