...
public class toaplan2
{
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_toaplan2 = new InitDriverPtr() { public void handler() (void)
	{
		old_p1_paddle_h = 0;
		old_p1_paddle_v = 0;
		old_p2_paddle_h = 0;
	...
	public static InitDriverPtr init_toaplan3 = new InitDriverPtr() { public void handler() (void)
	{
		toaplan2_sub_cpu = CPU_2_Zx80;
		mcu_data = 0;
	} };
	
	public static InitDriverPtr init_fixeight = new InitDriverPtr() { public void handler() (void)
	{
	...
	public static InitDriverPtr init_snowbro2 = new InitDriverPtr() { public void handler() (void)
	{
		toaplan2_sub_cpu = CPU_2_NONE;
		mcu_data = 0;	/* not used here actually */
	} };
	
	public static InitDriverPtr init_pipibibs = new InitDriverPtr() { public void handler() (void)
	{
		toaplan2_sub_cpu = CPU_2_Z80;
		mcu_data = 0;	/* not used here actually */
	} };
	
	public static InitDriverPtr init_pipibibi = new InitDriverPtr() { public void handler() (void)
	{
		int A;
		int oldword, newword;
	...
	public static InitDriverPtr init_truxton2 = new InitDriverPtr() { public void handler() (void)
	{
	...
	public static InitDriverPtr init_raizing = new InitDriverPtr() { public void handler() (void)
	{
		toaplan2_sub_cpu = CPU_2_Z80;
		mcu_data = 0;	/* not used here actually */
	} };
	
	public static InitDriverPtr init_battleg = new InitDriverPtr() { public void handler() (void)
	{
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress batrider_sound_readmem[]={
		...
		new Memory_ReadAddress( 0xf000, 0xf007, batrider_sound_data_z80_r1 ), ///
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	...
	*/
	...
	#ifdef LSB_FIRST
	static GfxLayout truxton2_tx_tilelayout = new GfxLayout
	(
		8,8,	/* 8x8 characters */
		1024,	/* 1024 characters */
		4,		/* 4 bits per pixel */
	...
	(
		...
		4,		/* 4 bits per pixel */
		new int[] { 0, 1, 2, 3 },
		new int[] { 0+8, 4+8, 16+8, 20+8, 32+8, 36+8, 48+8, 52+8 },
		new int[] { 0*64, 1*64, 2*64, 3*64, 4*64, 5*64, 6*64, 7*64 },
		8*64
	);
	#endif
	...
	#ifdef LSB_FIRST
	static GfxLayout batrider_tx_tilelayout = new GfxLayout
	(
		8,8,	/* 8x8 characters */
		1024,	/* 1024 characters */
		4,		/* 4 bits per pixel */
	...
	***************************************************************************/
	...
	public static GameDriver driver_kbash	   = new GameDriver("1993"	,"kbash"	,"toaplan2.java"	,rom_kbash,null	,machine_driver_kbash	,input_ports_kbash	,init_toaplan2	,ROT0	,	"Toaplan", "Knuckle Bash", GAME_NO_SOUND )
	public static GameDriver driver_truxton2	   = new GameDriver("1992"	,"truxton2"	,"toaplan2.java"	,rom_truxton2,null	,machine_driver_truxton2	,input_ports_truxton2	,init_truxton2	,ROT270	,	"Toaplan", "Truxton II / Tatsujin II / Tatsujin Oh (Japan)" )
	...
	public static GameDriver driver_batsugun	   = new GameDriver("1993"	,"batsugun"	,"toaplan2.java"	,rom_batsugun,null	,machine_driver_batsugun	,input_ports_batsugun	,init_toaplan3	,ROT270	,	"Toaplan", "Batsugun", GAME_NO_SOUND )
	public static GameDriver driver_batugnsp	   = new GameDriver("1993"	,"batugnsp"	,"toaplan2.java"	,rom_batugnsp,driver_batsugun	,machine_driver_batsugun	,input_ports_batsugun	,init_toaplan3	,ROT270	,	"Toaplan", "Batsugun Special Ver.", GAME_NO_SOUND )
	public static GameDriver driver_snowbro2	   = new GameDriver("1994"	,"snowbro2"	,"toaplan2.java"	,rom_snowbro2,null	,machine_driver_snowbro2	,input_ports_snowbro2	,init_snowbro2	,ROT0	,	"[Toaplan] Hanafram", "Snow Bros. 2 - With New Elves" )
	public static GameDriver driver_mahoudai	   = new GameDriver("1993"	,"mahoudai"	,"toaplan2.java"	,rom_mahoudai,null	,machine_driver_mahoudai	,input_ports_mahoudai	,init_raizing	,ROT270	,	"Raizing (Able license)", "Mahou Daisakusen (Japan)" )
	public static GameDriver driver_shippumd	   = new GameDriver("1994"	,"shippumd"	,"toaplan2.java"	,rom_shippumd,null	,machine_driver_shippumd	,input_ports_shippumd	,init_raizing	,ROT270	,	"Raizing/8ing", "Shippu Mahou Daisakusen (Japan)" )
	public static GameDriver driver_battleg	   = new GameDriver("1996"	,"battleg"	,"toaplan2.java"	,rom_battleg,null	,machine_driver_battleg	,input_ports_battleg	,init_battleg	,ROT270	,	"Raizing/8ing", "Battle Garegga" )
	public static GameDriver driver_batrider	   = new GameDriver("1998"	,"batrider"	,"toaplan2.java"	,rom_batrider,null	,machine_driver_batrider	,input_ports_batrider	,init_battleg	,ROT270	,	"Raizing/8ing", "Armed Police Batrider (Japan, version B)" )
	public static GameDriver driver_batridra	   = new GameDriver("1998"	,"batridra"	,"toaplan2.java"	,rom_batridra,driver_batrider	,machine_driver_batrider	,input_ports_batrider	,init_battleg	,ROT270	,	"Raizing/8ing", "Armed Police Batrider (Japan, version A)" )
}
