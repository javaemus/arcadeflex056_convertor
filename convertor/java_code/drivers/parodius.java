...
public class parodius
{
	...
	/* prototypes */
	public static InitMachinePtr parodius_init_machine = new InitMachinePtr() { public void handler() ( void );
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_parodius = new InitDriverPtr() { public void handler() (void)
	{
