...
public class itech32
{
	...
	static InputPortPtr input_ports_shufshot = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* 080000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START1 );
		PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );
	...
	static RomLoadPtr rom_shufshot = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_sftm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x8000, REGION_CPU1, 0 );
	...
	static RomLoadPtr rom_sftm110 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x8000, REGION_CPU1, 0 );
	...
	static RomLoadPtr rom_sftmj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x8000, REGION_CPU1, 0 );
	...
	public static GameDriver driver_pairs	   = new GameDriver("1994"	,"pairs"	,"itech32.java"	,rom_pairs,null	,machine_driver_pairs	,input_ports_pairs	,init_bloodstm	,ROT0	,	"Strata/Incredible Technologies", "Pairs" )
	public static GameDriver driver_sftm	   = new GameDriver("1995"	,"sftm"	,"itech32.java"	,rom_sftm,null	,machine_driver_sftm	,input_ports_sftm	,init_sftm	,ROT0	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.12)" )
	public static GameDriver driver_sftm110	   = new GameDriver("1995"	,"sftm110"	,"itech32.java"	,rom_sftm110,driver_sftm	,machine_driver_sftm	,input_ports_sftm	,init_sftm110	,ROT0	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.10)" )
	public static GameDriver driver_sftmj	   = new GameDriver("1995"	,"sftmj"	,"itech32.java"	,rom_sftmj,driver_sftm	,machine_driver_sftm	,input_ports_sftm	,init_sftm	,ROT0	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.12N, Japan)" )
	public static GameDriver driver_shufshot	   = new GameDriver("1997"	,"shufshot"	,"itech32.java"	,rom_shufshot,null	,machine_driver_sftm	,input_ports_shufshot	,init_shufshot	,ROT0	,	"Strata/Incredible Technologies", "Shuffleshot" )
}
