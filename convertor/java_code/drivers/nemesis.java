...
public class nemesis
{
	...
	public static Memory_ReadAddress city_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),
		new Memory_ReadAddress( 0x8000, 0x87ff, MRA_RAM ),
	...
	public static Memory_WriteAddress city_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),
		new Memory_WriteAddress( 0x8000, 0x87ff, MWA_RAM ),
		...
		new Memory_WriteAddress( 0xb000, 0xb00d, K007232_write_port_0_w ),
		new Memory_WriteAddress( 0xc000, 0xc000, city_sound_bank_w ), /* 7232 bankswitch */
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	...
	static InputPortPtr input_ports_blkpnthr = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );
	...
	static InputPortPtr input_ports_citybomb = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );
	...
	static InputPortPtr input_ports_nyanpani = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );
	...
	***************************************************************************/
	...
	public static GameDriver driver_salamand	   = new GameDriver("1986"	,"salamand"	,"nemesis.java"	,rom_salamand,null	,machine_driver_salamand	,input_ports_salamand	,null	,ROT0	,	"Konami", "Salamander (version D)" )
	public static GameDriver driver_salamanj	   = new GameDriver("1986"	,"salamanj"	,"nemesis.java"	,rom_salamanj,driver_salamand	,machine_driver_salamand	,input_ports_salamand	,null	,ROT0	,	"Konami", "Salamander (version J)" )
	...
	public static GameDriver driver_blkpnthr	   = new GameDriver("1987"	,"blkpnthr"	,"nemesis.java"	,rom_blkpnthr,null	,machine_driver_blkpnthr	,input_ports_blkpnthr	,null	,ROT0	,	"Konami", "Black Panther" )
	public static GameDriver driver_citybomb	   = new GameDriver("1987"	,"citybomb"	,"nemesis.java"	,rom_citybomb,null	,machine_driver_citybomb	,input_ports_citybomb	,null	,ROT270	,	"Konami", "City Bomber (World)" )
	public static GameDriver driver_citybmrj	   = new GameDriver("1987"	,"citybmrj"	,"nemesis.java"	,rom_citybmrj,driver_citybomb	,machine_driver_citybomb	,input_ports_citybomb	,null	,ROT270	,	"Konami", "City Bomber (Japan)" )
	public static GameDriver driver_kittenk	   = new GameDriver("1988"	,"kittenk"	,"nemesis.java"	,rom_kittenk,null	,machine_driver_nyanpani	,input_ports_nyanpani	,null	,ROT0	,	"Konami", "Kitten Kaboodle" )
	public static GameDriver driver_nyanpani	   = new GameDriver("1988"	,"nyanpani"	,"nemesis.java"	,rom_nyanpani,driver_kittenk	,machine_driver_nyanpani	,input_ports_nyanpani	,null	,ROT0	,	"Konami", "Nyan Nyan Panic (Japan)" )
}
